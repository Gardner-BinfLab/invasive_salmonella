...
samtools view -b -S bowtieout.sam -t topgenes.fai > samtoolsout.bam
...
./vcfandfasta_to_edited.pl bcftools.vcf topgenes.fna sample_edited
...
rm hmmsearch hmmsearch.parse sample.faa sample.faa.trim votes.csv missinggenes
