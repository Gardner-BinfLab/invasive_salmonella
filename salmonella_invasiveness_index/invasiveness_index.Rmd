...
directory <- "~/Documents/salmonella/salmonella_invasiveness_index/"
...
genedata <- genedata[,order(colnames(genedata))]
...
ggplot(melted, aes(x = Gene, y = variable, fill = value)) + geom_tile() + scale_fill_manual("Prediction", values=c("black", "white"))
